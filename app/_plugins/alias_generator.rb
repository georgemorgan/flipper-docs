...
#     alias: /post/6301645915/how-i-keep-limited-pressing-running/something.html
#   ---
#
# Example Post Configuration:
#
...
#     layout: post
#     title: "How I Keep Limited Pressing Running"
#     alias: [/first-alias/something.html, /second-alias/something.html]
#   ---
#
# Author: Thomas Mango
  ...
  class AliasGenerator < Generator
    ...
    def generate_aliases(destination_path, aliases)
      ...
      alias_paths.flatten.each do |alias_path|
        ...
        alias_file = File.extname(alias_path).empty? ? "something.html" : File.basename(alias_path)
...
<html>
  ...
  Redirecting...
  <script>
    var latest = '#{@site.data["flipper_versions"].last["release"]}';
